        ...
        <div className='w-full bg-black relative pb-20'>
            <div className='w-full md:max-w-7xl mx-auto px-5 md:px-6 flex flex-col lg:gap-5 relative mt-32 md:mt-40 max-md:items-center'>
                <Image
                    ...
                    height={350}
                    sizes='100vw'
                    className='absolute z-20 right-0 top-0 lg:-translate-y-52 md:-translate-y-35 -translate-y-20 h-auto lg:w-[350px] w-[250px] md:w-[300px] md:block hidden'
                />

                <h2 className='text-3xl md:text-4xl font-bold text-white mb-10 uppercase w-full z-30 max-md:text-right'>In-Game Currency</h2>

                <div className='flex max-md:flex-col items-center gap-5'>
                    <div className='flex items-center gap-5 lg:gap-10 z-30'>
                        {currency.map((curr) => (
                            <Image
                                src={curr.imageUrl}
                                alt={curr.name}
